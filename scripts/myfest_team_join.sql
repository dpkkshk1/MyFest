...
CREATE TABLE `team_join` (
  ...
  KEY `fk_team_join_Team1_idx` (`fk_team_id`),
  KEY `fk_team_join_User1_idx` (`fk_user_id`),
  CONSTRAINT `fk_team_join_Team1` FOREIGN KEY (`fk_team_id`) REFERENCES `team` (`team_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_team_join_User1` FOREIGN KEY (`fk_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `team_join` VALUES (0,15,2),(1,16,1);
...
-- Dump completed on 2019-02-07  9:21:58
